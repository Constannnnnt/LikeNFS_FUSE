...
NFSFuse::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_nfs_crash_(NFSFuse_method_names[14], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status NFSFuse::Stub::nfs_crash(::grpc::ClientContext* context, const ::nfsFuse::CrashRequestParams& request, ::nfsFuse::CrashResponseParams* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_nfs_crash_, context, request, response);
}

void NFSFuse::Stub::experimental_async::nfs_crash(::grpc::ClientContext* context, const ::nfsFuse::CrashRequestParams* request, ::nfsFuse::CrashResponseParams* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_nfs_crash_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::nfsFuse::CrashResponseParams>* NFSFuse::Stub::Asyncnfs_crashRaw(::grpc::ClientContext* context, const ::nfsFuse::CrashRequestParams& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::nfsFuse::CrashResponseParams>::Create(channel_.get(), cq, rpcmethod_nfs_crash_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::nfsFuse::CrashResponseParams>* NFSFuse::Stub::PrepareAsyncnfs_crashRaw(::grpc::ClientContext* context, const ::nfsFuse::CrashRequestParams& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::nfsFuse::CrashResponseParams>::Create(channel_.get(), cq, rpcmethod_nfs_crash_, context, request, false);
}
...
NFSFuse::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      NFSFuse_method_names[14],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< NFSFuse::Service, ::nfsFuse::CrashRequestParams, ::nfsFuse::CrashResponseParams>(
          std::mem_fn(&NFSFuse::Service::nfs_crash), this)));
}
...
::grpc::Status NFSFuse::Service::nfs_crash(::grpc::ServerContext* context, const ::nfsFuse::CrashRequestParams* request, ::nfsFuse::CrashResponseParams* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
